...
const CompanyProposal = () => {
  ...
  return (
    <div className="p-8 w-full lg:w-[80%] mx-auto">
      ...
      <InputField label="Tell us about your project" type="textarea" />
      <FileInputMultiple
        label="Upload Files"
      ...
      <div className="w-full flex justify-end items-center gap-8 mt-8">
        ...
        <MainBtn text={"Send Proposal"}  onClick={()=> router.push("/find-employee/company-proposal/success?projectId=1")} />
      </div>
    </div>
  );
};

export default CompanyProposal;
