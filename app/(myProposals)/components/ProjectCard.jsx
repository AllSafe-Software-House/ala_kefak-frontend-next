...
const ProjectCard = ({ project }) => {
  return (
    <Link href={`/proposal-detailes?proposalId=${project.id}`} className="w-full p-2 md:p-4 border rounded-xl shadow hover:shadow-md transition bg-white dark:bg-transparent flex flex-col justify-start items-start gap-2 md:gap-3 ">
